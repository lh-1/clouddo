...
public class FileController {
    ...
    public ResponseResult getToken() {
        return ResponseResult.ok().put("token", FilterContextHandler.getToken()).put("url", "http://localhost:8002/api-cms/file/upload")
    ...
    public ResponseResult upload(MultipartFile file, String key) {
        try {
            ...
            return ResponseResult.ok().put("resPath", resPath);
        } catch (IOException e) {
            e.printStackTrace();
